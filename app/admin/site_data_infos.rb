ActiveAdmin.register SiteDataInfo do
  ...
  index do 
    ...
    column "Plugins" do |site|
      link_to site.plugins, admin_plugins_path("q[url_id_equals]" => site.url_id, "q[status_equals]" => 1)
    end
    column "Js" do |site|
      link_to site.js, admin_js_infos_path("q[url_id_equals]" => site.url_id, "q[status_equals]" => 1)
    end
    column "Themes" do |site|
      link_to site.themes, admin_themes_path("q[url_id_equals]" => site.url_id, "q[status_equals]" => 1)
    end
    column :cloudflare
  end
end
